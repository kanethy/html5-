...
server.get('/single',(req,res)=>{
  //同步读取01_single.html文件，编码方式是utf8
...
//接收单文件上传时的接口
//avatar是01_single.html中input的name名称
...
let storage = multer.diskStorage({
  ...
  filename:function(req,file,cb){
      ...
      //获取文件的扩展名
      //substr-截取字符串  lastIndexOf('.')--最后一个点开始 +1---不包括. 
      //toLowerCase()---小写
...
server.post('/drag',upload2.array('face'),(req,res)=>{
  ...
  for(let n = 0; n < req.files.length;n++){
    ...
    //得到的path是 'upload\\2021-03-12\\ec3d37d0-831c-11eb-8499-530fe6516d47.jpg',
    // 需要把双\\改为/
